...
INSERT INTO Cargo (Nome, Tipo, Local, QuantidadeEleitos) VALUES 
...
INSERT INTO Candidato (PessoaID, PartidoID, CargoID, DataCandidatura, ViceCandidatoID) VALUES 
...
INSERT INTO ProcessoJudicial (CandidatoID, Status, Resultado, DataInicio, DataTermino) VALUES 
...
INSERT INTO EquipeApoio (CandidatoID, Ano) VALUES 
(1, 2024),
(3, 2024),
(4, 2024),
(5, 2024),
...
INSERT INTO ParticipanteEquipe (PessoaID, EquipeApoioID) VALUES 
(2, 1), -- Ana Costa na equipe de apoio de João Silva
(3, 3), -- Pedro Almeida na equipe de apoio de si mesmo
(4, 4), -- Mariana Rsocha na equipe de apoio de si mesma
...
INSERT INTO Doacao (DoadorID, CandidatoID, Valor, Data) VALUES 
...
INSERT INTO Pleito (Ano, CargoID, CandidatoID, VotosRecebidos) VALUES 
